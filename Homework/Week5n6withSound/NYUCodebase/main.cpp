...
int main(int argc, char *argv[])
{
	...
	Mix_Chunk *enemyFire;
	Mix_Chunk *enemyPoof;
	selfFire = Mix_LoadWAV("laser_shot.wav");
	enemyFire = Mix_LoadWAV("enemy_shot.wav");
	enemyPoof = Mix_LoadWAV("dead.wav");
